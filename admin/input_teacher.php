...
if (isset($_POST['simpan'])) {
    ...
    if (empty($error)) {
        if ($foto_name) {
            ...
            $foto_name = "teacher_" . time() . "_" . $foto_name;
        ...
        if ($id != "") {
            $sql1   = "update profileteacher set nama = '$nama',foto='$foto_name',isi='$isi',tgl_isi=now() where id = '$id'";
        } else {
            $sql1       = "insert into profileteacher(nama,foto,isi) values ('$nama','$foto_name','$isi')";
        }
...
?>
<h1>Halaman Admin Input Data Teacher</h1>
<div class="mb-3 row">
    <a href="teacher.php">
        << Kembali ke halaman admin Teacher</a>
</div>
<?php
if ($error) {
?>
